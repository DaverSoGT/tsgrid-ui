...
// src/tsfield.ts
var tsfield_exports = {};
__export(tsfield_exports, {
  TsField: () => TsField
});
module.exports = __toCommonJS(tsfield_exports);
...
var TsField = class extends TsBase {
      ...
      if (focus.val() === "") {
        ...
        setTimeout(() => {
          ...
          if (options.icon) {
            ...
            query9(this.helpers.search).find('[data-icon="search"]').addClass("show-search");
          } else {
            focus.css("margin-left", "0px");
            query9(this.helpers.search).find('[data-icon="search"]').removeClass("show-search");
          }
        }, 1);
      }
  ...
  focus(event) {
    if (this.type == "list" && document.activeElement == this.el) {
      ...
      if (event.showMenu !== false && this.options.openOnFocus !== false && query9(this.el).hasClass("has-focus") && !this.tmp.overlay?.overlay?.displayed) {
        setTimeout(() => {
  ...
  */
  ...
  addSearch() {
    ...
    query9(helper).find("input").off(".tsg-helper").on("focus.tsg-helper", (event) => {
  ...
  addMultiSearch() {
    ...
    div.on("mousedown", (event) => {
      query9(event.target).addClass("has-focus");
    }).on("mouseup", (event) => {
      query9(event.target).removeClass("has-focus");
    }).on("click", (event) => {
      this.focus(event);
      this.updateOverlay();
    });
