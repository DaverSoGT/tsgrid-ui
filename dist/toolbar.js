...
// src/tstoolbar.ts
var tstoolbar_exports = {};
__export(tstoolbar_exports, {
  TsToolbar: () => TsToolbar
});
module.exports = __toCommonJS(tstoolbar_exports);
...
var TsToolbar = class extends TsBase {
  ...
  setCount(id, count, className, style) {
    ...
    if (btn.length > 0) {
      ...
      this.set(id, { count });
      const after = query9(this.box).find(`#tb_${this.name}_item_${TsUtils.escapeId(id)} .tsg-tb-count > span`);
