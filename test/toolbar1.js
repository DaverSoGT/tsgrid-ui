jQuery(function () {
    jQuery('#toolbar').TsToolbar({
        ...
        items: [
            ...
            { type: 'new-line' },
            { type: 'button', id: 'item1', icon: 'TsUi-icon-search', text: 'button', count: 5, tooltip: 'Some' },
            { type: 'break' },
            { type: 'check', id: 'item11', icon: 'TsUi-icon-box', text: 'check' },
            { type: 'radio', id: 'item12', group: 1, icon: 'TsUi-icon-cross', text: 'radio', count: 5 },
            { type: 'radio', id: 'item13', group: 1,icon: 'TsUi-icon-plus', text: 'radio', count: 5 },
            { type: 'break' },

            { type: 'button', id: 'itemA1', icon: 'TsUi-icon-search', text: 'button 1',  arrow: true, tooltip: 'Some 1' },
            { type: 'button', id: 'itemA2', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA3', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA4', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA5', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'new-line' },
            { type: 'button', id: 'itemA6', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA7', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA8', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA9', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
            { type: 'button', id: 'itemA10', icon: 'TsUi-icon-search', text: 'button2',  tooltip: 'Some2' },
            { type: 'button', id: 'itemA11', icon: 'TsUi-icon-search', text: 'button',  tooltip: 'Some' },
